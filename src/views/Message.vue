...
import { MessageParams, RulesItem, Rules } from "../type/index";
...
export default class Message extends Vue{
    ...
    private catchTime: number = 0;  //缓存时间
    ...
    private async submit(): Promise<void> {
        ...
        if(nowTime - this.catchTime < 60000){
            this.$message({
        ...
        this.times++;
        this.catchTime = nowTime;
        this.$message({
            message: "感谢你的留言, 博主会尽快回复你的",
            type: "success"
        });
        this.params.content = "";
    }
